...
export const FILE_METADATA_REQUIRED_TAGS = DIR_VALIDATION + "metadata-required.json";

export const FILE_CONFIG                     = DIR_CONFIG + "userscript.json";
export const FILE_CONFIG_PROPERTIES_REQUIRED = DIR_VALIDATION + "userscript-required.json";
export const FILE_CONFIG_PROPERTIES_OPTIONAL = DIR_VALIDATION + "userscript-optional.json";
